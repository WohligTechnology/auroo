...
var ftpString = "U2FsdGVkX19xXPQtATWYKPkBjNAAKiKckb1ahM0yqbGa+yXn8vOPYppNC6m4B0NwBt7WN/srUuNNH+wHlA1wdjYyIxB13h0DCrqm3zkt51/qouAtdWYZ9tgDR3IGz1UWtZKyv3DRp9E34HGavMtMhw==";
...
gulp.task('production', gulpSequence(["copy:img", "copy:fonts", "sass:production", "minify:indexproduction", "minify:views"], 'clean:tmp', "concat:js", 'clean:tmp', "templatecache", "uglify:js","minify:css", 'clean:tmp', "inlinesource", 'clean:tmp', 'clean:tmp', 'clean:tmp', "zip"));
gulp.task('productionc', gulpSequence(["copy:img", "copy:fonts", "sass:production", "minify:indexproduction", "minify:views"], 'clean:tmp',  "concat:js", 'clean:tmp',"templatecache", "uglify:js", "minify:css", 'clean:tmp', "inlinesource", 'clean:tmp', 'clean:production', "copy:indexhtml", 'clean:tmp', "zip", "deploy"));
